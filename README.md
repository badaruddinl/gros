...
The runtime ABI and real16 memory model fixtures are Bash-only and validate the implemented `int 30h` return contracts plus seeded memory boundaries directly from the stage-2 `.gro` bytes.
