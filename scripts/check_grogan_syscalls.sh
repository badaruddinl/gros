...
require_hex 77040000 "missing GWO checksum contract"
...
require_hex 488b0c25 "missing saved user RIP state"
require_hex 4c8b1c25 "missing saved user flags state"
require_hex 488b2425 "missing saved user stack state"
