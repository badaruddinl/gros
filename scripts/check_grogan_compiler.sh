...
MODULE_SOURCE="$ROOT/examples/grown-alpha/module-main.grw"
MODULE_GWO="$TMP_DIR/module.gwo"
"$ROOT/scripts/grc0.sh" "$MODULE_SOURCE" "$MODULE_GWO"
[ "$("$ROOT/scripts/grvm.sh" "$MODULE_GWO")" = 42 ] || fail "multi-module host output must be 42"
...
echo "Grogan compiler: deterministic GWO2 lowering, multi-module host VM, and image embedding ok"
